...
$.get("http://localhost/mymvc/public/get_instant_data.php?online_friend_chat=result", function(data){
...
$.get("http://localhost/mymvc/public/get_instant_data.php?get_members=result", function(data){
